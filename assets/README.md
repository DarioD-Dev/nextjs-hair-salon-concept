...
`Fraunces-SemiBold.woff` ist die Display-Schrift der Seite, Gewicht 600, unter
der **SIL Open Font License 1.1**. Bezogen über die Google-Fonts-CSS-API mit
einer alten User-Agent-Kennung, weil die API modernen Browsern woff2
ausliefert.
